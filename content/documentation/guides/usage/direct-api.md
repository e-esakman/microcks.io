...
Then adding a reference JSON payload - such a payload can also include some [templating expressions](https://microcks.io/documentation/references/templates/) to get some more dynamic data. Here we define producing random stock symbols and range price values:
