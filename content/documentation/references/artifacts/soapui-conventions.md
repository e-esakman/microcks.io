...
As shown above, you are also free to add some assertions within your TestStep requests. the SoapUI documentation introduces the assertion concept on [this page](https://www.soapui.org/docs/functional-testing/getting-started-with-assertions/). Assertions in TestSteps can be later reused when wanting to use Microcks for [Contract testing](../tests) of your Service.
